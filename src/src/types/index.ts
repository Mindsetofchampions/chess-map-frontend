...
export interface UserProfile {
  ...
  role?: Role;
  org_id?: string | null;
  persona_streaks?: Record<string, number>; // personaKey -> streak count
}
...
export interface PersonaDef {
  ...
  backstory: string;
  introPrompt: string;
  keywords: string[]; // for event search
  mcqTags: string[];  // for MCQ selection
}
...
export interface MCQQuestion {
  ...
  choices: MCQChoiceMap; // JSONB in DB
  correct_key: string;
