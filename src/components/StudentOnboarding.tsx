    ...
    try {
      ...
      const updates: any = {
        user_metadata: {
          ...
          parent_consent: { agreePrivacy, agreeHIPAA, parentName },
        },
      };
  ...
  return (
    <div className='bg-glass border-glass rounded-xl p-6 max-w-3xl mx-auto'>
      ...
      <p className='text-sm text-gray-200 mb-4'>
        Complete onboarding and parent consent to access quests, the map, and the store.
      </p>
      ...
      <div className='space-y-3'>
        <label className='flex items-center gap-2'>
          ...
          <span className='text-sm text-gray-200'>
            I consent to the app's privacy policy for student participation
          </span>
        </label>
        ...
        <label className='flex items-center gap-2'>
          ...
          />
          <span className='text-sm text-gray-200'>
            I consent to health/film/media releases (if applicable)
          </span>
        </label>
        ...
        <label className='block'>
          ...
          <input
            className='mt-1 p-2 rounded w-full bg-black/20 border border-white/10'
            value={parentName}
        ...
        <label className='block'>
          ...
          <div className='text-xs text-gray-400'>
            Upload will be supported in a follow-up (requires storage + admin review workflow)
          </div>
        </label>
        ...
        <div className='flex items-center gap-2'>
          <button
            disabled={!agreePrivacy || !agreeHIPAA || !parentName || submitting}
