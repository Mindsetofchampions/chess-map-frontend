...
export const CustomContent: Story = {
  args: {
    ...
    subtitle: 'Experience the future of learning through interactive quests, rewards, and community engagement.',
  },
};
...
export const MobileView: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Hero section optimized for mobile devices with stacked layout and touch-friendly buttons.',
      },
    },
  },
};
