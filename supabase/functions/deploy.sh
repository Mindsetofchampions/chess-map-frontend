...
echo "Deploying admin_create_org..."
npx supabase functions deploy admin_create_org "${REF_ARG[@]}"

echo "Deploying admin_update_org..."
npx supabase functions deploy admin_update_org "${REF_ARG[@]}"

echo "Deploying admin_list_organizations..."
npx supabase functions deploy admin_list_organizations "${REF_ARG[@]}"

echo "Deploying admin_delete_org..."
npx supabase functions deploy admin_delete_org "${REF_ARG[@]}"
