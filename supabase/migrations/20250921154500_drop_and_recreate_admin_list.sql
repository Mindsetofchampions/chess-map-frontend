-- Drop and recreate get_admin_user_list with SQL and stable return type

-- Ensure function is dropped first to allow signature change if needed
DROP FUNCTION IF EXISTS public.get_admin_user_list();

-- Recreate with enum role and simple left join
